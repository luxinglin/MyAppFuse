...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.h3c.service.impl.PasswordTokenManager#generateRecoveryToken(com.h3c.user.model.User)
     */
    @Override
    ...
    /**
     * @see com.h3c.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.h3c.user.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.h3c.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
