package com.h3c.user.controller;
...
import com.h3c.user.model.Role;
import com.h3c.user.model.User;
import com.h3c.user.service.RoleManager;
                ...
                if (StringUtils.isBlank(request.getParameter("version"))) {
                    ...
                    try {
                        ...
                        sendUserMessage(user, getText("newuser.email.message", user.getFullName(), locale),
                                com.h3c.common.util.RequestUtil.getAppURL(request) + resetPasswordUrl);
